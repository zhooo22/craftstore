  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 20px 80px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "start" }}>
        <div>
          <div style={{ background: "var(--beige)", borderRadius: 16, height: 420, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 140, border: "1px solid var(--border)", overflow:"hidden" }}>{product.image?.startsWith("http") ? <img src={product.image} alt={product.name} style={{ width:"100%", height:"100%", objectFit:"cover" }}/> : product.image}</div>    </div>
